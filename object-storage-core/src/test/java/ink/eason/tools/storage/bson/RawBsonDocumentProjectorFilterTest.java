...
class RawBsonDocumentProjectorFilterTest {
    ...
    class BasicTypeFilterTests {
        ...
        void testMatch_String_ImplicitEq_Success() {
            ...
            RawBsonDocument result = RawBsonDocumentProjector.project(testDoc, DUMMY_PROJECTION, RawBsonDocumentProjector.ProjectionMode.INCLUSIVE, filter);
    ...
    class NestedStructureTests {
        ...
        void testMatch_NestedDocumentField_2_Success() {
            // filter: nestedDoc.nestedInt > 49
            BsonDocument filter = BsonDocument.parse("{ 'nestedDoc.nestedInt': { '$gt': 49 } }");
            RawBsonDocument result = RawBsonDocumentProjector.project(testDoc, Set.of("nestedDoc"), ProjectionMode.EXCLUSIVE, filter);
