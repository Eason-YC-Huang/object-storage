...
import ink.eason.tools.storage.bson.RawBsonProjector.ProjectionMode;
...
class RawBsonProjectorFilterTest {
    ...
    class BasicTypeFilterTests {
        ...
        void testMatch_String_ImplicitEq_Success() {
            ...
            RawBsonDocument result = RawBsonProjector.project(testDoc, DUMMY_PROJECTION, RawBsonProjector.ProjectionMode.INCLUSIVE, filter);
    ...
    class NestedStructureTests {
        ...
        void testMatch_NestedDocumentField_2_Success() {
            // filter: nestedDoc.nestedInt > 49
            BsonDocument filter = BsonDocument.parse("{ 'nestedDoc.nestedInt': { '$gt': 49 } }");
            RawBsonDocument result = RawBsonProjector.project(testDoc, Set.of("nestedDoc"), ProjectionMode.EXCLUSIVE, filter);
